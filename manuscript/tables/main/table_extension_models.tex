...
\caption{Buffered spatial extension. Family selection uses inner development macro-F1; outer scores are retrospective proxy agreement.}\label{tab:models}
...
Histogram gradient boosting & 0.611 & 0.846 & 0.704--0.857 & 0.051 \\

...
\includegraphics[width=\textwidth]{figure_s06_annual_climate_trends.pdf}
...
\begin{figure}[tbp]\centering
\includegraphics[width=\textwidth]{figure_s05_weather_product_comparison.pdf}
...
\end{equation}
Spectral and terrain summaries were re-extracted for 2,000 draws at each $d_{\max}\in\{30,60,120\}$ m. An undisplaced re-extraction supplies the appropriate control. The oriented percentile definition (main text, Eq.~3) distinguishes this endpoint reference from the fixed summary-table reference.

...
3. Mohsin Khan confirms that all three authors screened suggested reviewers Megarry, Tapete and Fatorić and report no known recent collaboration, shared affiliation or other conflict. Enter them in Editorial Manager if requested. The journal chooses the handling editor and reviewers; reviewer leniency cannot be established in advance.
